...
zip -r ./dist/post-modified-time-block.zip \
	block.json \
        post-modified-time-block.php \
        license.txt \
	$build_files \
	readme.txt

# Reset `post-modified-time-block.php`.
git checkout post-modified-time-block.php

# Unzip plugin zip file
unzip ./dist/post-modified-time-block.zip -d "./dist/post-modified-time-block/"
